#!/usr/bin/env python3
"""批量生成 AprilTag tag36h11 ID 0-7 的无尺寸 PNG 模板。"""

import os, struct, zlib

CODES = {
    # AprilRobotics/apriltag tag36h11.c 的前八个官方 codeword。
    0: 0x0d7e00984b, 1: 0x0dda664ca7, 2: 0x0dc4a1c821, 3: 0x0e17b470e9,
...
TOTAL = 10
SCALE = 60  # 600px total; 8-cell detection square = 480px
...
def main():
    outdir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'tags_5cm')
